<?php
/**
 * Customer refunded order note
 *
 * Overridden by copying to yourtheme/woocommerce/emails/customer-refunded-order-note.php. 
 *
...
$email_heading = 'Order Status Set To Refund';
		...
		<tr><td valign="top" align="center">
			...
			<tbody><tr><td id="body_content" valign="top">
				...
				<div id="body_content_inner">
                    ...
                    <h3> Order Details: </h3><h4> Order ID: 5608</h4>
                    <table id="t_ord_det"> 
                    <tbody><tr>
