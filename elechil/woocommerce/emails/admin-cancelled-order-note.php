<?php
/**
 * Admin cancelled order note
 *
 * Overridden by copying to yourtheme/woocommerce/emails/admin-cancelled-order-note.php.
 *
...
$email_heading = 'Order Status Set To Cancelled';
