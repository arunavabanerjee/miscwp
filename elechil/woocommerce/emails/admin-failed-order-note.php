<?php
/**
 * Admin failed order note
 *
 * Overridden by copying to yourtheme/woocommerce/emails/admin-failed-order-note.php.
 *
...
$email_heading = 'Order Status Set To Failed';
			...
			<tbody><tr><td id="body_content" valign="top">
				...
				<div id="body_content_inner">
                    ...
                    <tbody><tr>
                        ...
                        <th style="padding:5px;font-size:13px;width:100px;text-align:left"><?php _e( 'Total' ); ?></th></tr> 
