<?php
/**
 * Customer processing order note
 *
 * Overridden by copying to yourtheme/woocommerce/emails/customer-processing-order-note.php. 
 *
...
$email_heading = 'Order Status Set To Processing';
