<?php
/**
 * Customer completed order note
 *
 * Overridden by copying to yourtheme/woocommerce/emails/customer-completed-order-note.php. 
 *
...
$email_heading = 'Order Status Set To Completed';
