<?php
/**
 * Customer on-hold order note
 *
 * Overridden by copying to yourtheme/woocommerce/emails/customer-on-hold-order-note.php.
 *
...
$email_heading = 'Order Status Set To On Hold';
