...
<div class="container">
	...
	<?php if ( count($data['items']['item']) > 0 ) : ?>
		...
		<div class="shop-top-cat-ppath" style="width:100%;height:150px;overflow:hidden">
		<?php //categories ?>
		...
		<div class="col-md-11 col-sm-11 div-ppath" style="height:66px;overflow:hidden;">
		<h3 style="font-size: 10px;text-align: right;margin-top: -3px;margin-bottom: 0px;">+More</h3>
		...
		<div class="buttons" style="text-align:center;">
		  <button type="button" id="btnConfirm" name="btnConfirm" value="pConfirm" style="height:26px;font-size:11px;">Confirm</button>
	          <button type="button" id="btnCancel" name="btnCancel" value="pCancel" style="height:26px;font-size:11px;">Cancel</button>
		</div>
		<?php } ?>
		</div>
		...
		<div class="col-md-1 col-sm-1" style="margin-top:17px;"><h2 class="shop-title" style="font-weight:bold;"><?php echo $navi["title"]; ?></h2></div>
		<div class="col-md-11 col-sm-11 div-cat" style="height:66px;overflow:hidden;">
		<h3 style="font-size: 10px;text-align: right;margin-top: -3px;margin-bottom: 0px;">+More</h3>
...
jQuery( ".shop-top h5" ).click(function() {
 jQuery(this).toggle("fast", function() { 
   if( jQuery(this).text() == "+More" ){
     ...
     jQuery(".shop-top-cat-ppath").css('height','150px');
...
jQuery( ".div-ppath h3" ).click(function() {
 jQuery(this).toggle("fast", function() { 
   if( jQuery(this).text() == "+More" ){
     ...
     jQuery(this).parent().css('height','66px');
