...
function generatePolicyPDFs($applicationID, $importType){ 
   ...
   if($applicationID == NULL){ //generate test pdf 
      ...
      if(($record[0][5] == 'S5A') || ($record[0][5] == 'S5B') || ($record[0][5] == 'S5C') || ($record[0][5] == 'S5D') 
        ...
        if(($record[0][5] == 'S5B') || ($record[0][5] == 'S5BP')){ $pdf->Text(125,113,'x'); $pdf->Text(112,117,'x'); }
        if(($record[0][5] == 'S5C') || ($record[0][5] == 'S5CP')){ $pdf->Text(135,113,'x'); $pdf->Text(112,117,'x'); }
        if(($record[0][5] == 'S5D') || ($record[0][5] == 'S5DP')){ $pdf->Text(145,113,'x'); $pdf->Text(112,117,'x'); }
