             ...
             <table width="100%" class="popup-box">
		      ...
		      <span class="name-<?php the_id();?> item_name"><?php the_title();?></span>
                  ...
                  <td class="text-right price-td">
                    <strong class="col-xs-12"><span class="price-<?php the_id();?> price food-price"> <?php if(isset($currency_menu) && !empty($currency_menu)){ echo esc_attr($currency_menu);}else{}?> <?php echo esc_attr( $textmoney );?></span></strong>
...
$('.total-hidden-charges2').val(prev_charges);
          ...
          <input type="hidden" name="order_time"  id="order_time" value="<?php echo time();?>" />
			...
			<?php if($orderPerHr < $maxOrderPerHr){ ?>
			   <button type="submit" class="btn_full"><?php echo esc_html__( 'Order now', 'quickfood' );?></button>
