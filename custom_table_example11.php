...
function custom_table_example_admin_menu()
{
	...
	/* listings for class */
	add_submenu_page('applications', __('Applications', 'custom_table_example'), __('Maid + Embassy', 'custom_table_example'), 'activate_plugins', 'applications&s=Maid_Embassy', 'custom_table_example_persons_page_handler');
	add_submenu_page('applications', __('Applications', 'custom_table_example'), __('Foreign Worker', 'custom_table_example'), 'activate_plugins', 'applications&s=Foreign_Worker', 'custom_table_example_persons_page_handler');
	add_submenu_page('applications', __('Applications', 'custom_table_example'), __('Work Injury', 'custom_table_example'), 'activate_plugins', 'applications&s=Work_Injury', 'custom_table_example_persons_page_handler');
