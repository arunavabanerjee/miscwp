...
<tbody>
    ...
    <tr class="form-field">
        ...
        <td><input id="a_exp_type" name="a_exp_type" type="text" style="width: 85%" value="<?php echo esc_attr($item['export_type'])?>"
                   size="50" class="code" placeholder="<?php _e('Export Type', 'custom_table_example')?>" required></td>
    </tr>
    <tr class="form-field">
