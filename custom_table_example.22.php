...
class Custom_Table_Example_List_Table extends WP_List_Table
{
    ...
    {
        if($item['payment_approved'] == 0){ //return '0';
            return '<img src="'.get_template_directory_uri().'/images/tick-green-512.png" alt="Failed Image" width="50" height="50" />';
        } else{ //return '1';
            return '<img src="'.get_template_directory_uri().'/images/download-red-512.png" alt="Success Image" width="50" height="50" />';
        }
    }    
