        ...
        <div class="modal-body-right pull-right">
            <div class="modal-content">
			    ...
			    <div class="form-group">
                                <input name="userfname" type="text" class="form-control email-input-1" placeholder="<?php esc_attr_e('Firstname','homey'); ?>"/>
				<input name="userlname" type="text" class="form-control email-input-1" placeholder="<?php esc_attr_e('Lastname','homey'); ?>"/>
                            </div>
                            <!--<div class="form-group">
                            ...
                            <div class="checkbox">
                                <label>
                                    <input name="privacy_policy" type="checkbox"><?php echo wp_kses($forms_gdpr_text, homey_allowed_html()); ?>
                                </label>
                            </div>
                            <?php } ?>

                            <?php wp_nonce_field( 'homey_register_nonce', 'homey_register_security' ); ?>
                            <input type="hidden" name="action" value="homey_child_register">
                            <button type="submit" class="homey-child-register-button btn btn-primary btn-full-width">
				<?php echo esc_html__('Register', 'homey'); ?>
			    </button>
                        </form>
                        <p class="text-center"><?php echo esc_html__('Do you already have an account?', 'homey'); ?> 
			  <a href="#" data-toggle="modal" data-target="#modal-login" data-dismiss="modal"><?php echo esc_html__('Log In', 'homey'); ?></a>
			</p>
                    </div>
                </div><!-- /.modal-content -->
                <?php } else {
