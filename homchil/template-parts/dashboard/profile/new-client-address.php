...
<div class="block">
    <div class="block-title">
        <div class="block-left">
            <h2 class="title"><?php echo 'Enter Client '.esc_html__('Address', 'homey'); ?></h2>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" id="country" class="form-control" value="<?php //echo esc_attr($country); ?>" placeholder="<?php //echo esc_attr('country', 'homey'); ?>">
                </div>
            </div>-->
            <div class="col-sm-12 text-right">
		<div class="homey_add_new_client_messages_bottom"></div>
                <button type="submit" class="homey_new_client_save btn btn-success btn-xs-full-width"><?php echo esc_attr($homey_local['save_btn']); ?></button>
            </div>
        </div>
    </div>
</div><!-- block -->
