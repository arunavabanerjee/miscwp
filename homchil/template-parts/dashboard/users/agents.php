            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
				    ...
				    <?php if(homey_is_admin()) { ?>
                                    <div class="mt-10">
                                        <a class="btn btn-primary btn-slim" href="<?php echo esc_url($all_agents); ?>"><?php esc_html_e('All', 'homey'); ?> (<?php echo esc_attr($users_count['total_users']); ?>)</a>
                                        <?php
				    ...
				    <?php } ?>
						...
						if($dashboarduser_role == 'homey_brokers'){ 
						  ...
						  wp_reset_postdata(); $rmeta_query=[];
							...
							<?php } else { ?>
							<?php echo esc_html__('Not Assigned Yet', 'homey-child'); ?>
							<?php } ?>
                                                    </td>
						    ...
						    <?php } ?>
                                                    ...
                                                    <td data-label="<?php echo esc_html__('Actions', 'homey'); ?>">
                                                        <div class="custom-actions">
                                                            <a class="btn btn-success" style="margin-top:-4px;" href="<?php echo esc_url($single_user_link); ?>"><?php esc_html_e('Detail', 'homey'); ?></a>
							    <?php if($dashboarduser_role == 'homey_brokers'){ ?>
							   ...
							   style="background:#f15e75;border-color:#f15e75;color:#FFF;padding:2px 5px;font-weight: bold;">
							    ...
							    <?php } ?>
                                        ...
                                        <?php        
                                            ...
                                            echo esc_html__('No Agents found.', 'homey');
                                            echo '</td></tr>';
                                        }
                                        ?>
                                    </tbody>
