...
if(empty($single_user_id) || (!homey_is_admin() && $dashboarduser_role == "homey_host") ) {
    return;
}
...
/*get user data*/
$user_data = get_userdata($single_user_id); //var_dump($user_data); exit;
$user_address = get_user_meta($user_data->ID, 'address', true);
$user_city = get_user_meta($user_data->ID, 'city', true);
$user_pcode = get_user_meta($user_data->ID, 'postalcode', true);

$user_age = get_user_meta($user_data->ID, 'age', true);
$user_phone = get_user_meta($user_data->ID, 'phone', true);
$user_occup = get_user_meta($user_data->ID, 'occupation', true);
$user_gender = get_user_meta($user_data->ID, 'gender', true);
    ...
    <div class="dashboard-content-area">
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="dashboard-area">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation">
                                <a href="#properties" aria-controls="properties" role="tab" data-toggle="tab"><?php esc_html_e('Properties', 'homey'); ?></a>
                            </li>

			    <?php if ($user_role == 'homey_agents'){ ?>
                            <li role="presentation">
                                <a href="#leads" aria-controls="leads" role="tab" data-toggle="tab"><?php esc_html_e('Leads', 'homey'); ?></a>
                            </li>
			    <?php } ?>
                                            ...
                                            <div class="col-sm-10">
                                                <ul class="list-unstyled list-lined">
                                                    ...
                                                    <li>
                                                        ...
                                                        <?php } ?>
							<?php if($user_role == 'homey_agents') { 
								echo esc_html__('Agents', 'homey-child'); 
							      } elseif($user_role == 'homey_renter'){
								echo esc_html__('Renter', 'homey-child'); 
							      } elseif($user_role == 'homey_host'){
								echo esc_html__('Host', 'homey-child'); 					
							      } else{ echo esc_attr($user_role); } ?>
                                                    </li>
                                                    <?php } ?>
                                                </ul>
                                                ...
                                                <ul class="list-unstyled list-lined">
                                                   <li>
                                                        <strong><?php esc_html_e('Age', 'homey'); ?></strong> 
                                                        <?php 
                                                        if(!empty($user_age)) { 
                                                            echo esc_attr($user_age); 
                                                        } else {
                                                            echo '-';
                                                        }
                                                        ?>
                                                   ...
                                                   <li>
                                                        <strong><?php esc_html_e('Phone', 'homey'); ?></strong> 
                                                        <?php 
                                                        if(!empty($user_phone)) { 
                                                            echo esc_attr($user_phone); 
                                                        } else {
                                                            echo '-';
                                                        }
                                                        ?>
                                                   ...
                                                   <li>
                                                        <strong><?php esc_html_e('Occuption', 'homey'); ?></strong> 
                                                        <?php 
                                                        if(!empty($user_occup)) { 
                                                            echo esc_attr($user_occup); 
                                                        } else {
                                                            echo '-';
                                                        }
                                                        ?>
                                                   ...
                                                   <li>
                                                        <strong><?php esc_html_e('Gender', 'homey'); ?></strong> 
                                                        <?php 
                                                        if(!empty($user_gender)) { 
                                                            echo esc_attr($user_gender); 
                                                        } else {
                                                            echo '-';
                                                        }
                                                        ?>
                                                   ...
                                                   <li>
                                                        <strong><?php esc_html_e('City', 'homey'); ?></strong> 
                                                        <?php 
                                                        if(!empty($user_city)) { 
                                                            echo esc_attr($user_city); 
                                                        } else {
                                                            echo '-';
                                                        }
                                                        ?>
                                                   ...
                                                   <li>
                                                        <strong><?php esc_html_e('Postal Code', 'homey'); ?></strong> 
                                                        <?php 
                                                        if(!empty($user_pcode)) { 
                                                            echo esc_attr($user_pcode); 
                                                        } else {
                                                            echo '-';
                                                        }
                                                        ?>
                                            ...
                                            <?php } elseif ($payout_payment_method == 'wire') { ?>
                                                ...
                                                <li>
                                                    ...
                                                    if(!empty($wir_street_address)) {
                                                        echo $wir_street_address.', '.$wir_city.', '.$wir_state.', '.$wir_zip_code;
                                                    } else {
                                                        echo '-';
                                                    }
                                                    ?>
				...
				<?php if( $user_role == 'homey_host' ){ ?>	
				<?php $largs = array( 'post_type' => 'listing', 'posts_per_page' => -1, 
						'post_status' => 'publish', 'author' => $single_user_id, 'fields' => 'ids', ); 
				 $lqry_res = new WP_Query($largs); 
				 $prop_listing_ids = $lqry_res->posts; wp_reset_postdata(); ?>
				<?php } elseif( $user_role == 'homey_agents' ){ ?>
				<?php 
				  $largs = array( 'post_type' => 'listing', 'posts_per_page' => -1, 'post_status' => 'publish', 'fields' => 'ids' ); 
				  $lmeta_query[] = array( 'key' => 'homey_assignedagent', 'value' => $single_user_id, 'compare' => '=' );
				  $largs['meta_query'] = $lmeta_query; $lqry_res = new WP_Query($largs); 
				  $prop_listing_ids = $lqry_res->posts; wp_reset_postdata(); $lmeta_query = []; ?>
				<?php } ?>
                                <div class="host-properties-section">
                                    <div class="block">
                                        <div class="block-title">
                                            <div class="block-left">
						<?php if( $user_role == 'homey_agents' ){ ?>
                                                <h2 class="title"><?php esc_html_e('Assigned Properties', 'homey'); ?></h2>
						<?php } else { ?>
                                                <h2 class="title"><?php esc_html_e('Properties List', 'homey'); ?></h2>
						<?php } ?>
                                            </div>
                                        </div>
                                        <div class="block-body" style="padding:10px 40px 20px 40px;">
                                            <div class="properties-section">
					    <?php if(!empty($prop_listing_ids)){ ?>
					    <?php $i=1; foreach($prop_listing_ids as $propId) { ?>
						<?php if($i%2==0){ ?>
						<div style="height:65px;background:#EEE;padding:4px;margin:0 0 3px 0;color:#171212;">
						<?php } else { ?>
						<div style="height:65px;background:#CCC;padding:4px;margin:0 0 3px 0;color:#171212;">
						<?php } ?>
						<div class="block-title" style="padding:0px;">
						<div class="block-left" style="padding-left:10px;width:10%">
						<?php if(has_post_thumbnail($propId)) {
                    	       			    echo get_the_post_thumbnail($propId, array(55,55), array('class'=>'img-responsive')); } ?>
						</div>
						<div class="block-right" style="float:left;padding-left:20px;width:90%">
					    ...
					    <?php $i++; } ?>
					    <?php } else { ?>
						<div style="height:55px;padding:4px;margin:0 0 3px 0;color:#171212;">
							No Properties Found For User 
						</div>
					    <?php } ?>
				...
				<?php $rargs = array( 'post_type' => 'homey_reservation', 'posts_per_page' => -1, 
						      'post_status' => 'publish', 'fields' => 'ids' ); 
				 $rmeta_query[] = array( 'key' => 'listing_renter', 'value' => $single_user_id, 'compare' => '=' );
				 $rargs['meta_query'] = $rmeta_query; $rqry_res = new WP_Query($rargs); //var_dump($rqry_res);
				 wp_reset_postdata(); $rmeta_query=[]; ?>
                                <div class="renter-leads-section">
                                    <div class="block">
                                        <div class="block-title">
                                            <div class="block-left">
                                                <h2 class="title"><?php esc_html_e('Leads and Bookings', 'homey'); ?></h2>
                                            </div>
                                        </div>
                                        <div class="block-body" style="padding:10px 40px 20px 40px;">
                                            <div class="leads-section">
						<?php if ( $rqry_res->have_posts() ){
						  $i=1; foreach($rqry_res->posts as $res1){ 
							$res_name = get_the_title($res1); 
							$res_listingId = get_post_meta($res1, 'reservation_listing_id', true); 
							$res_status = get_post_meta($res1, 'reservation_status', true); ?>
						<?php if($i%2==0){ ?>
						<div style="height:65px;background:#EEE;padding:4px;margin:0 0 3px 0;color:#171212;">
						<?php } else { ?>
						<div style="height:65px;background:#CCC;padding:4px;margin:0 0 3px 0;color:#171212;">
						<?php } ?>
						<div class="block-title" style="padding:0px;">
						<div class="block-left" style="float:left;padding-left:10px;width:10%">
						<?php if(has_post_thumbnail($res_listingId)) {
                    	       			    echo get_the_post_thumbnail($res_listingId, array(55,55), array('class'=>'img-responsive')); } ?>
						</div>
						<div class="block-right" style="float:left;padding-left:20px;width:90%">
						<div style="width:50%;float:left;">
			  			 <p style="margin:0px"><?php echo get_the_title($res_listingId); ?></p>
			  			 <p style="margin:0px">
						   <?php $address = get_post_meta( $res_listingId, 'homey_listing_address', true ); echo $address; ?>
			  			 </p>
						</div>
						<div style="width:30%;float:left;"><?php echo $res_name; ?></div>
						<div style="width:20%;float:left;"><?php homey_reservation_label($res_status); ?></div>
						</div>
						</div>
						</div>
					    	<?php $i++; } ?>
				...
				<?php $rargs = array( 'post_type' => 'homey_reservation', 'posts_per_page' => -1, 
						      'post_status' => 'publish', 'fields' => 'ids' ); 
				  $rmeta_query[] = array( 'key' => 'homey_agents', 'value' => $single_user_id, 'compare' => '=' );
				  $rargs['meta_query'] = $rmeta_query; $rqry_res = new WP_Query($rargs); //var_dump($rqry_res);
				  wp_reset_postdata(); $rmeta_query=[]; ?>
                                <div class="renter-leads-section">
                                    <div class="block">
                                        <div class="block-title">
                                            <div class="block-left">
                                                <h2 class="title"><?php esc_html_e('Assigned Leads', 'homey'); ?></h2>
                                            </div>
                                        </div>
                                        <div class="block-body" style="padding:10px 40px 20px 40px;">
                                            <div class="leads-section">
			    ...
			    <?php if(homey_is_admin()) { ?>
                            <div role="tabpanel" class="tab-pane <?php echo esc_attr($active_doc); ?>" id="documents">
                                <div class="block">
                                    ...
                                    <div class="block-body">
                                        <?php 
                                        $docVry = homey_user_document_for_verification($user_document_id, '800', '600', 'img-responsive'); 
                                        if(!empty($docVry)) {
                                            echo $docVry;
                                        }
                                        ?>
