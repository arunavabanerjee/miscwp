...
<div class="form-step">
    ...
    <div class="block">
        ...
        <div class="block-body">
		    ...
		    <select class="form-control select" id="city" name="locality" <?php homey_required('city'); ?>>
		    	...
		    	<select class="form-control select" id="countyState" id="state" name="administrative_area_level_1" <?php homey_required('state'); ?>>
            ...
            <div class="row add-listing-map">
                ...
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <div class="form-group">
                        <input type="text" name="lat" id="lat" class="form-control" placeholder="<?php echo esc_attr(homey_option('ad_lat')); ?>">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <div class="form-group">
                        <input type="text" name="lng" id="lng" class="form-control" placeholder="<?php echo esc_attr(homey_option('ad_long')); ?>">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
