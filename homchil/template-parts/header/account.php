    ...
    <div class="account-dropdown">
        <ul>
            ...
            if(homey_is_admin()) {
                ...
                if( !empty($all_users) ) {
                    echo '<li class="">
                        <a class="agent-link" href="'.esc_url($all_users).'"><i class="fa fa-users"></i>'.esc_html__('View All Agents', 'homey').'</a>';
            ...
            if( !empty($dashboard_reservations) ) {
                ...
                if(homey_is_renter()) {
                    ...
                    echo '<li>
                        <a href="'.esc_url($dashboard_reservations).'"><i class="fa fa-file"></i>'.esc_html__('My Active Leads', 'homey').'</a>
                    </li>';
                    echo '<li>
                        <a href="'.esc_url($dashboard_reservations.'?status=cancelled').'"><i class="fa fa-file"></i>'.esc_html__('Lead History', 'homey').'</a>
                    </li>';
                } else {
                    echo '<li>
		...
		if($currentuser_role == 'homey_brokers' || $currentuser_role == 'homey_agents'){
                  if( !empty($dashboard_listings) ) {
                    echo '<li>
                        <a href="'.esc_url($dashboard_listings).'"><i class="fa fa-file"></i> Current Listings </a>
                    </li>';
                  }
