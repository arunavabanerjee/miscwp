<?php
/**
 * Template Name: Listings List View
 */
get_header();
global $post, $wp_query, $paged, $listing_founds, $number_of_listings, $homey_prefix;
    ...
    <div class="container">
        <div class="row">
            <div class="<?php echo esc_attr($content_classes); ?>">
                ...
                <?php
                if ( $wp_query->have_posts() ) : $listing_founds = $wp_query->found_posts; ?>
